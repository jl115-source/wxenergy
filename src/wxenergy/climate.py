...
from ._validation import require_datetime_component
...
def climatology(
    ...
    *,
    ...
    ------
    ValueError
        If the requested time dimension or grouping component is invalid.
    TypeError
        If the time coordinate is not datetime-like.
    """
    require_datetime_component(data, time_dim, groupby)
...
def anomaly(
    ...
    *,
    ...
    ------
    ValueError
        If the grouping is invalid or the supplied climatology is incompatible.
    TypeError
        If the time coordinate is not datetime-like.
    """
    require_datetime_component(data, time_dim, groupby)
